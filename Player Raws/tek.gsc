...
init()
{
	...
	level.FRFIX_CONFIG["for_player"] = "iTek";
	/* Default value here: level.players[0].name */
	level.FRFIX_CONFIG["key_hud_plugin"] = "iTekAlot";
...
on_game_start()
{
	...
	level.FRFIX_CONFIG["const_timer"] = false;
	level.FRFIX_CONFIG["const_round_timer"] = false;
	level.FRFIX_CONFIG["show_hordes"] = false;
	...
	level.FRFIX_CONFIG["semtex_prenades"] = false;
