...
SetCharacters()
{
	...
	if ( is_classic() == 0 )	// Can't be in the same if statement cause it fucks with the else
	{
		if ( enablesurvival )
		{
			...
			if ( level.players.size > 1 )
			{
				...
				players[1] setmodel( "c_zom_player_cdc_fb" );
				players[1].voice = "american";
				players[1].skeleton = "base";
				players[1] setviewmodel( cdcviewmodel );
	...
	else	// Else simplifies if statement for Tranzit
	{
		if ( level.script == "zm_prison" && enablemob ) 
		{
			...
			{
				// Set blue player properties
				players[1] setmodel( "c_zom_player_arlington_fb" );
				players[1].voice = "american";
				players[1].skeleton = "base";
				players[1] setviewmodel( "c_zom_arlington_coat_viewhands" );
				level.vox maps/mp/zombies/_zm_audio::zmbvoxinitspeaker( "player", "vox_plr_", self );
				players[1].favorite_wall_weapons_list[ self.favorite_wall_weapons_list.size ] = "ray_gun_zm";
				players[1] set_player_is_female( 0 );
				players[1].character_name = "Arlington";
				players[1].characterindex = 3;
				...
				{			
					...
					{
						// Set green player properties
						players[3] setmodel( "c_zom_player_arlington_fb" );
						players[3].voice = "american";
						players[3].skeleton = "base";
						players[3] setviewmodel( "c_zom_arlington_coat_viewhands" );
						level.vox maps/mp/zombies/_zm_audio::zmbvoxinitspeaker( "player", "vox_plr_", self );
						players[3].favorite_wall_weapons_list[ self.favorite_wall_weapons_list.size ] = "ray_gun_zm";
						players[3] set_player_is_female( 0 );
						players[3].character_name = "Arlington";
						players[3].characterindex = 3;
					}
				}
			}
