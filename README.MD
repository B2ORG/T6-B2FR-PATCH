...
| - | `reticle` | `!r` | No | Allows for customizing gun reticle, values between 1 and 16 (eg. 16 is a red dot), 0 to make it random. Needs to be set BEFORE the gun is obtained |
